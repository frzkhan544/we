...
const MintForm = () => {  
  ...
  return(
    <form onSubmit={submissionHandler} className="col-md-12 mint-form">
      <div className="row justify-content-center">
        <div className="col-md-12">
          <input
            type='text'
            className={`${nameClass} mb-3`}
            placeholder='Name...'
            value={enteredName}
        ...
        <div className="col-md-12">
          <textarea
            ...
            rows="4" 
            cols="50"
            className={`${descriptionClass} mb-3`}
        ...
        <div className="col-md-12">
          <input
            type='file'
            className={`${fileClass} mb-3`}
            onChange={captureFile}
          />
        </div>
      </div>
      <button type='submit' className='btn info-btn btn-block'>MINT</button>
    </form>
  );
};
