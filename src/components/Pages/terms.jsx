...
const Terms = ({
    ...
    <CollectionProvider>
      ...
      "}</style>
        ...
        <br></br>
        <center><h1 style={{color:"#13287e"}}>Terms of Service</h1></center>
        <br></br>
        <h1 style={{color:"#13287e"}}>Website Terms and Conditions of Use</h1>
<h2 style={{color:"#13287e"}}>1. Terms</h2>
...
<h2 style={{color:"#13287e"}}>8. Your Privacy</h2>
<p style={{color:"#13287e"}}>Please read our Privacy Policy.</p>
<h2 style={{color:"#13287e"}}>9. Governing Law</h2>
